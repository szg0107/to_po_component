<template>
  <div class="home">
    <at-autocomplete v-model="input" :fetch-suggestions="querySearchAsync" placeholder="请输入内容"
                     @select="handleSelect">
      <i slot="suffix" class="search el-icon-search" @click="searchBtn"/>
    </at-autocomplete>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    createStateFilter (queryString) {
      return (state) => (state.value.toLowerCase()
    ...
    searchBtn () {
      ...
      this.restaurants.unshift({ value: this.input })
    },
    loadAll () {
      return [
        {
